...
abstract class AbstractRequest implements Request {
    ...
    {
        return $this->postFinanceUri;
    }

    /** PostFinance uri to send the customer to. Usually PaymentRequest::TEST or PaymentRequest::PRODUCTION */
    public function setPostFinanceUri($postFinanceUri)
    {
        $this->validatePostFinanceUri($postFinanceUri);
        $this->postFinanceUri = $postFinanceUri;
    }
    ...
    protected function validatePostFinanceUri($uri)
    {
